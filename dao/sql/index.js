export const getEmsTimeZone = (ems_name) => {
...
export const getLastTransaction = (uuid, statusComplete, oss, vendor) => {
...
export const insertAuditlogs = (columns, values) => {
  let nativeQuery = `INSERT INTO vson.snapshot_audit_logs(${columns}) values(${values})`
  return nativeQuery
}

export const updateAuditTracker = (FAILURESTATUS, uuid, lastModifiedTs) => {
